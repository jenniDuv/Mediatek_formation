 ...
 */
final class Version20240408123218 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE formation_add (id INT AUTO_INCREMENT NOT NULL, playlist_id INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, date DATE NOT NULL, INDEX IDX_4A4A16936BBD148 (playlist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
